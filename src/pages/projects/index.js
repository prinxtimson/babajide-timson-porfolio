    ...
    <div className="my-5 row align-items-center">
      <div className="col-lg-8">
        ...
        <p className="lh-lg">
          ...
          Developer for{" "}
          <Link to="https://tritekconslting.co.uk">Tritek Consulting Ltd</Link>,
          ...
          technology ranging from a CMS platform like WordPress, Shopify and Big
          Commerce to using frameworks like ReactJs, React Native, Laravel,
          AngularJs, Firebase, GatsbyJs and Nodejs.{" "}
        </p>
